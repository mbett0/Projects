...
enum State {leftTurnSignal,rightTurnSignal, first, BlindSpot, turnSignalBlind};
...
int tick(int state){
  switch (state) {
    case first: 
      ...
      else if ((distance < 9) && ((buttonLeft == 1) || (buttonRight == 1) )){
    ...
    case leftTurnSignal: 
      ...
      digitalWrite(leftLight, LOW);   // turn the LED off by making the voltage LOW
      delay(300);
      digitalWrite(leftLight, HIGH);  // turn the LED on (HIGH is the voltage level)
      delay(300);                      // wait for a second
      digitalWrite(leftLight, LOW);   // turn the LED off by making the voltage LOW
      ...
      delay(300);                      // wait for a second
      digitalWrite(rightLight, LOW);   // turn the LED off by making the voltage LOW
      delay(300);
      digitalWrite(rightLight, HIGH);  // turn the LED on (HIGH is the voltage level)
      delay(300);                      // wait for a second
      digitalWrite(rightLight, LOW);   // turn the LED off by making the voltage LOW
      ...
      case BlindSpot: 
        Serial.print("state: BlindSpot, distance: ");
